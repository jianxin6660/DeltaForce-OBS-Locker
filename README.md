...
> **🆕 最新更新（2026-07-02）**：针对 S10 赛季新地图“核电站 AZ3”中新增的“容器防护服”进行了专项隔离处理。此前 V3 版本模型易将该类防护服误判为真人目标，V4 版本中已通过专属特征标注将其单独归类为非人单位，有效消除误触发。
...
- 截至 **2026年7月02日**，本项目V4版本代码逻辑在本机测试环境中已针对S10赛季核电站AZ3地图完成初步验证；若因后续游戏更新导致原理验证失效，将在本仓库第一时间同步说明。  
